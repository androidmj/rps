...
h=d.xAxis[a.xAxis],z=d.yAxis[a.yAxis],m=a.width,A=a.height,B=v[a.anchorY],C=v[a.anchorX],r;if(e){var k=e instanceof f.Point?"point":e instanceof f.Series?"series":null;"point"===k?(a.xValue=e.x,a.yValue=e.y,r=e.series):"series"===k&&(r=e);c.visibility!==r.group.visibility&&c.attr({visibility:r.group.visibility})}e=p(a.xValue)?h.toPixels(a.xValue+h.minPointOffset)-h.minPixelPadding:a.x;k=p(a.yValue)?z.toPixels(a.yValue):a.y;if(!isNaN(e)&&!isNaN(k)&&n(e)&&n(k)){b&&(b.attr(a.title),b.css(a.title.style));
