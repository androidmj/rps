var HighchartsAdapter=function(){var e="undefined"!==typeof Effect;return{init:function(a){e&&(Effect.HighchartsTransition=Class.create(Effect.Base,{initialize:function(b,c,d,f){this.element=b;this.key=c;var e=b.attr?b.attr(c):$(b).getStyle(c);"d"===c&&(this.paths=a.init(b,b.d,d),this.toD=d,e=0,d=1);this.start(Object.extend(f||{},{from:e,to:d,attribute:c}))},setup:function(){HighchartsAdapter._extend(this.element);this.element._highchart_animation||(this.element._highchart_animation={});this.element._highchart_animation[this.key]=
